...
0. **[Lab wiki (map + runtime notes)](../wiki/README.md)** — GitHub updater and deploy tips.
...
| CI / release notes | [release-and-ci-strategy.md](release-and-ci-strategy.md) · [wiki: updater](../wiki/README.md) |
