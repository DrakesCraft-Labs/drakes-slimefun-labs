...
0. **[Wiki del laboratorio (mapa + runtime)](../wiki/README.md)** — updater GitHub y despliegue.
...
| CI / releases | [release-and-ci-strategy.md](release-and-ci-strategy.md) · [wiki: updater](../wiki/README.md) |
