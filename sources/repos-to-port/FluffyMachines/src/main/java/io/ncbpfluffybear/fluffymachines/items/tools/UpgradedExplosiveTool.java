...
import com.github.drakescraft_labs.slimefun4.implementation.items.tools.ExplosiveTool;
...
class UpgradedExplosiveTool extends ExplosiveTool {
    ...
    private void breakBlocks(Player p, ItemStack item, Block b, List<Block> blocks, List<ItemStack> drops) {
        ...
        if (callExplosionEvent.getValue()) {
            BlockExplodeEvent blockExplodeEvent = new BlockExplodeEvent(b, b.getState(), blocks, 0.0F, org.bukkit.ExplosionResult.DESTROY);
