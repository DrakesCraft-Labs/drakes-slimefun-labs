package com.github.drakescraft-labs.infinitylib.abstracts;
...
public abstract class AbstractTicker extends SlimefunItem {
    ...
    protected AbstractTicker(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem item, Config config) {
                BlockMenu menu = com.github.drakescraft-labs.slimefun4.legacy.api.BlockStorage.getInventory(b);
                if (menu != null) {
    ...
    public void postRegister() {
        new com.github.drakescraft-labs.slimefun4.legacy.api.inventory.BlockMenuPreset(getId(), getItemName()) {
            @Override
            public void init() {
                setupMenu(this);
            }
            ...
            @Override
            public int[] getSlotsAccessedByItemTransport(com.github.drakescraft-labs.slimefun4.legacy.api.item_transport.ItemTransportFlow flow) {
                return new int[0];
            }

            @Override
            public int[] getSlotsAccessedByItemTransport(com.github.drakescraft-labs.slimefun4.legacy.api.inventory.DirtyChestMenu menu, com.github.drakescraft-labs.slimefun4.legacy.api.item_transport.ItemTransportFlow flow, ItemStack item) {
    ...
    public int[] getTransportSlots(@Nonnull com.github.drakescraft-labs.slimefun4.legacy.api.inventory.DirtyChestMenu menu, @Nonnull com.github.drakescraft-labs.slimefun4.legacy.api.item_transport.ItemTransportFlow flow, ItemStack item) {
        return new int[0];
    }
}
