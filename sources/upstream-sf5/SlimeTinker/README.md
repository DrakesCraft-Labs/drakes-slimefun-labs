...
SlimeTinker is a Slimefun5 addon that tries its best to recreate the amazing Tinker's Construct
Mod ([link](https://www.curseforge.com/minecraft/mc-mods/tinkers-construct)) in Vanilla Minecraft.

## Download SlimeTinker

Download from [GitHub Releases](https://github.com/Slimefun5/SlimeTinker/releases).
